...
@Controller()
export class EstatutoIdoso {
  @Get('/run-estatuto-idoso')
  async executeEstatutoIdoso(@Res() response: Response) {
    const url = 'http://www.planalto.gov.br/ccivil_03/Leis/2003/L10.741.htm'; // Estatuto Idoso
    ...
    try {
      ...
      try {
        ...
        const documento = {
          titulo: 'estatuto-idoso', // Título personalizado
