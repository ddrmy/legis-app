...
@Controller()
export class EstatutoOAB {
  @Get('/run-estatuto-oab')
  async executeEstatutoOAB(@Res() response: Response) {
    const url = 'http://www.planalto.gov.br/ccivil_03/Leis/L8906.htm'; // Estatuto OAB
    ...
    try {
      ...
      try {
        ...
        const documento = {
          titulo: 'estatuto-oab', // Título personalizado
