...
@Controller()
export class EstatutoCriancaAdolescente {
  @Get('/run-estatuto-crianca-adolescente')
  async executeEstatutoCriancaAdolescente(@Res() response: Response) {
    const url = 'http://www.planalto.gov.br/ccivil_03/Leis/L8069.htm'; // Estatuto Crianca Adolescente
    ...
    try {
      ...
      try {
        ...
        const documento = {
          titulo: 'estatuto-crianca-adolescente', // Título personalizado
