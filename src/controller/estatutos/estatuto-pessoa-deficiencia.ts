...
@Controller()
export class EstatutoPessoaDeficiencia {
  @Get('/run-estatuto-pessoa-deficiencia')
  async executeEstatutoPessoaDeficiencia(@Res() response: Response) {
    const url = 'http://www.planalto.gov.br/CCIVIL_03/_Ato2015-2018/2015/Lei/L13146.htm'; // Estatuto Pessoa Deficiência
    ...
    try {
      ...
      try {
        ...
        const documento = {
          titulo: 'estatuto-pessoa-deficiencia', // Título personalizado
