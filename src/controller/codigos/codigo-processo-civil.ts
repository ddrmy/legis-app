...
@Controller()
export class CodigoProcessoCivil {
  @Get('/run-codigo-processo-civil')
  async executeCodigoProcessoCivil(@Res() response: Response) {
    const url = 'http://www.planalto.gov.br/ccivil_03/_ato2015-2018/2015/lei/L13105.htm'; // Codigo Processo Civil
    ...
    try {
      ...
      try {
        ...
        const documento = {
          titulo: 'codigo-processo-civil', // Título personalizado
