...
@Controller()
export class ConsolidacaoLeisTrabalho {
  @Get('/run-consolidacao-leis-trabalho')
  async executeConsolidacaoLeisTrabalho(@Res() response: Response) {
    const url = 'http://www.planalto.gov.br/ccivil_03/Decreto-Lei/Del5452.htm'; // Consolidacao Leis Trabalho
    ...
    try {
      ...
      try {
        ...
        const documento = {
          titulo: 'consolidacao-leis-trabalho', // Título personalizado
