...
@Controller()
export class CodigoDefesaConsumidor {
  @Get('/run-codigo-defesa-consumidor')
  async executeCodigoDefesaConsumidor(@Res() response: Response) {
    const url = 'http://www.planalto.gov.br/ccivil_03/Leis/L8078.htm'; // Codigo Defesa do Consumidor
    ...
    try {
      ...
      try {
        ...
        const documento = {
          titulo: 'codigo-defesa-consumidor', // Título personalizado
