...
@Controller()
export class CodigoProcessoPenal {
  @Get('/run-codigo-processo-penal')
  async executeCodigoProcessoPenal(@Res() response: Response) {
    const url = 'http://www.planalto.gov.br/ccivil_03/Decreto-Lei/Del3689.htm'; // Codigo Processo Penal
    ...
    try {
      ...
      try {
        ...
        const documento = {
          titulo: 'codigo-processo-penal', // Título personalizado
