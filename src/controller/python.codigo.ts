...
@Controller()
export class PythonCodigo {
  @Get('/run-python-codigo')
  async executePythonCodigo(@Res() response: Response) {
    const url = 'http://www.planalto.gov.br/ccivil_03/Leis/L5869.htm'; // Processo civil
    ...
    try {
      ...
      try {
        ...
        const documento = {
          titulo: 'Teste de Request Código', // Título personalizado
