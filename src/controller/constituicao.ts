...
export class Constituicao {
  @Get('/run-constituicao')
  async executeConstituicao(@Res() response: Response) {
    const url = 'http://www.planalto.gov.br/ccivil_03/Constituicao/Constituicao.htm'; // Constituicao
    ...
    try {
      ...
      try {
        ...
        const documento = {
          titulo: 'constituicao', // Título personalizado
